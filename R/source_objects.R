...
cbs_columns = c(
  ...
  "Tackles" = "dst_tackles",
  "Defensive Fumbles Recovered" = "dst_fum_recvr",
  "Forced Fumbles" = "dst_fumbles",
  "Sacks" = "dst_sacks",
...
nfl_columns = c(
  ...
  "Turnover Fum Rec" = "dst_fum_recvr",
  "Score TD" = "dst_td",
...
rts_columns = c(
  ...
  "sacks" = "dst_sacks",
  "ints" = "dst_int",
  "fumbles_recovered" = "dst_fum_recvr"
)
...
fleaflicker_columns = c(
  ...
  "Defense FF" = "dst_fumbles",
  "Defense FR" = "dst_fum_recvr",
  "Defense TD" = "dst_td",
